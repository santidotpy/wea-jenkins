package com.um.softaplicada.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.um.softaplicada.service.EmailAlreadyUsedException ||
            ex instanceof com.um.softaplicada.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.um.softaplicada.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.um.softaplicada");
    }
}
